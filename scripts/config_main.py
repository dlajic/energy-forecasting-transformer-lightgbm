...
TEMPERATURE_RAW_PATH = os.path.join(
    BASE_DIR, "data", "external", "Temperature_chicago.csv"
)
TEMPERATURE_PROCESSED_PATH = os.path.join(
    BASE_DIR, "data", "external", "temperature_chicago_preprocessed.csv"
)
